    ...
    render() {
        return (
            <div className = 'landing-page-container'>
                ...
                <Spring delay = {1000} trail = {1000}
                            from={{
                                width: 100,
                                opacity: 0,
                                padding: 0,
                                background:
                                'linear-gradient(to right,#AE9172, #6A5046)',
                                transform:
